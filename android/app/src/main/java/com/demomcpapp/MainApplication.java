...
import com.demomcpapp.InteractionStudioReactPackage;
/**
 * To run:
...
public class MainApplication extends Application implements ReactApplication {
    ...
    public void onCreate() {
        ...
        evergage.setUserId("60ca3dd0bc46c451");

        evergage.start(new ClientConfiguration.Builder()
                .account("nkroehlmerkle.us-4")
                .dataset("mqazi_test")
                .usePushNotifications(true)
                .build());

        Log.d("DEBUG",evergage.toString());
    ...
    private static void initializeFlipper(
        ...
        */
                Class<?> aClass = Class.forName("com.demomcpapp.ReactNativeFlipper");
                aClass
